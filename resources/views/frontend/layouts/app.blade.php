...
<head>
    ...
    <meta name="app-url" content="https://zwader.com/">
    <meta name="file-base-url" content="https://zwader.com/">
...
@if (\App\BusinessSetting::where('type', 'facebook_pixel')->first()->value == 1)
    ...
    <script>
        ...
        fbq('track', 'PageView');
            ...
            fbq('track', 'Search');
            fbq('track', 'Subscribe', {value: '0.00', currency: 'PKR', predicted_ltv: '0.00'});
...
})(window,document,'script','dataLayer','GTM-5P7JQBD');</script>
...
<noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-5P7JQBD"
